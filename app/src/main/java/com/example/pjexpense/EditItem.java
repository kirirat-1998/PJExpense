...
public class EditItem extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        int i = 0;
        int selection = 0;
        while (i < Mode2Saving.getCat().size()) {
            if (categorie.equals(Mode2Saving.getCat().get(i).getName())) {
//                ((RelativeLayout) findViewById(R.id.textBar)).setBackgroundColor(Mode2Saving.getCat().get(i).getColor());
//                ((RelativeLayout) findViewById(R.id.textBar1)).setBackgroundColor(Mode2Saving.getCat().get(i).getColor());
//                ((TextView) findViewById(R.id.title)).setBackgroundColor(Mode2Saving.getCat().get(i).getColor());

                findViewById(R.id.textBar).setBackgroundColor(Color.parseColor("#FFA025"));
                findViewById(R.id.textBar1).setBackgroundColor(Color.parseColor("#d4d4d4"));
                findViewById(R.id.title).setBackgroundColor(Color.parseColor("#d4d4d4"));
                selection = i;
            }
            i++;
        }
    ...
    public void addItemsOnSpinner2() {
        ...
        int i = 0;
        while (i < Mode2Saving.getCat().size()) {
            list.add(Mode2Saving.getCat().get(i).getName());
            i++;
        }
...
//                ((RelativeLayout) findViewById(R.id.textBar)).setBackgroundColor(Mode2Saving.getCat().get(position).getColor());
//                ((RelativeLayout) findViewById(R.id.textBar1)).setBackgroundColor(Mode2Saving.getCat().get(position).getColor());
//                ((TextView) findViewById(R.id.title)).setBackgroundColor(Mode2Saving.getCat().get(position).getColor());

                findViewById(R.id.textBar).setBackgroundColor(Color.parseColor("#FFA025"));
                findViewById(R.id.textBar1).setBackgroundColor(Color.parseColor("#ffffff"));
                findViewById(R.id.title).setBackgroundColor(Color.parseColor("#ffffff"));
            }
