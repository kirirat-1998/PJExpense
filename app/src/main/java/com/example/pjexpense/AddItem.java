...
//                findViewById(R.id.textBar).setBackgroundColor(Mode2Saving.getCat().get(position).getColor());
//                findViewById(R.id.title).setBackgroundColor(Mode2Saving.getCat().get(position).getColor());
    ...
    /**
     * Sauvegarde l'item et envoies les données à la Mode2Saving
     * @param view view
     * @throws ParseException
     */
    public void save(View view) throws ParseException {
        ...
        if (title.equals("") || txt.equals(""))
            Toast.makeText(getApplicationContext(), "กรุณากรอกชื่อเป้าหมาย หรือจำนวนเงิน", Toast.LENGTH_SHORT).show();
        else {
            ...
            if (date.after(current)) {
                ...
                Toast.makeText(getApplicationContext(), "ไม่สามารถกรอกวันที่ย้อนหลังได้", Toast.LENGTH_SHORT).show();
        }
    }
}