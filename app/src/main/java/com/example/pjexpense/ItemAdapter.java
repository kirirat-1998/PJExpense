...
public class ItemAdapter extends ArrayAdapter<Item> {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        final ArrayList<Categorie> cat = Mode2Saving.getCat();
        ...
        while (i < cat.size()) {
            if (Item.getCategorie().equals(cat.get(i).getName())) {
                ...
                if (Item.getStatus() == com.example.pjexpense.Item.Status.DONE) {
                    viewHolder.back.setBackgroundColor(Color.parseColor("#e9fce1"));
                    viewHolder.categorie.setBackgroundColor(Color.parseColor("#409E15"));
                }
            }
            i++;
        }
